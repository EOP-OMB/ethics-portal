 ...
 * - `"square"`&mdash;The marker is a square.
 * - `"circle"`&mdash;The marker is a circle.
 * - `"triangle"`&mdash;The marker is a triangle.
 * - `"cross"`&mdash;The marker is a cross.
 * - `"rect"`&mdash;The marker is a rectangle.
 * - `"roundedRect"`&mdash;The marker is a rounded rectangle.
 *
 * @example
 * ```ts
