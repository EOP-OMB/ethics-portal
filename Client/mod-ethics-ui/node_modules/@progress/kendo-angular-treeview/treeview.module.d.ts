...
import * as i2 from "./treeview.component";
import * as i3 from "./node-template.directive";
import * as i4 from "./check.directive";
import * as i5 from "./disable.directive";
import * as i6 from "./expand.directive";
import * as i7 from "./selection/select.directive";
import * as i8 from "./hierarchy-binding.directive";
import * as i9 from "./flat-binding.directive";
import * as i10 from "./drag-and-drop/drag-and-drop.directive";
import * as i11 from "./drag-and-drop/drag-clue/drag-clue-template.directive";
import * as i12 from "./drag-and-drop/drop-hint/drop-hint-template.directive";
