...
*-------------------------------------------------------------------------------------------*/
import { Component, Renderer2, Input, Output, EventEmitter, ViewChild, ElementRef, HostBinding, Injector } from '@angular/core';
import { isDocumentAvailable, isSafari } from '@progress/kendo-angular-common';
