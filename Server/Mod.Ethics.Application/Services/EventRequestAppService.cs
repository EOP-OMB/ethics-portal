...
namespace Mod.Ethics.Application.Services
{
    ...
    {
        public EventRequestAppService(IEventRequestRepository repository, IObjectMapper objectMapper, ILogger<IAppService> logger, IModSession session) : base(repository, objectMapper, logger, session)
        {
