...
namespace Mod.Ethics.Infrastructure.Migrations
{
    ...
    [Migration("20250226182927_AddGivenByToGuidance")]
    partial class AddGivenByToGuidance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mod.Ethics.Domain.Entities.EventRequest", b =>
                {
                    ...
                    b.Property<string>("CommsComment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Mod.Ethics.Domain.Entities.OgeForm450", b =>
                {
                    ...
                    b.Property<bool>("HasSpousePaidEmployment")
                        .HasColumnType("bit");
